    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          {/* Why We're Better Block */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="mb-8 bg-gradient-to-br from-primary/5 via-purple-50 to-pink-50 dark:from-primary/10 dark:via-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 border-2 border-primary/20"
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-xl mb-3 text-slate-900 dark:text-white">
                  Почему наши песни звучат как настоящие хиты?
                </h3>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-3">
                  Мы создали уникальную технологию: наша система обучена на огромной музыкальной базе с тысячами композиций всех жанров и эпох. Это не просто генератор по шаблону.
                </p>
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  <span className="font-semibold text-primary">Главный секрет:</span> даже с одинаковыми вводными данными каждая песня получается совершенно разной - с уникальной мелодией, аранжировкой и настроением. Вы никогда не получите «копипаст». Каждая композиция - это оригинальный трек, который звучит профессионально и цепляет с первых секунд.
                </p>
              </div>
            </div>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "Честно - это AI-технология, но не та, что звучит роботизированно. Мы используем самые современные модели синтеза голоса, которые обучены на записях профессиональных вокалистов. Результат: чистый, живой звук без металлического призвука. Включите любой пример - сами услышите разницу."
              },
              {
                question: "Сколько это стоит?",
                answer: "590 рублей - и всё включено. Полноценный трек с вокалом, аранжировкой и текстом, написанным специально под вашу историю. Без скрытых доплат и подписок."
              },
              {
                question: "За сколько будет готова песня?",
                answer: "Примерно за 10 минут после оплаты. Вы получите трек на почту и сможете сразу скачать его в личном кабинете. Да, это быстро - но качество при этом не страдает."
              },
              {
                question: "А если мне не понравится?",
                answer: "Тогда мы бесплатно переделаем песню. Можно изменить жанр, настроение, добавить или убрать детали из текста. Наша цель - чтобы вам захотелось включить трек ещё раз, а не просто «сойдёт»."
              },
              {
                question: "Что нужно написать для создания песни?",
                answer: "Расскажите о человеке: имя, характер, увлечения, смешные или трогательные моменты из жизни. Чем больше деталей - тем круче получится. Не бойтесь писать много: мы вплетём всё самое яркое в текст."
              },
              {
                question: "Можно выбрать жанр и голос?",
                answer: "Конечно. Доступны все популярные жанры: поп, рок, рэп, шансон, джаз, электроника, блюз, кантри, акустика. Голос - мужской или женский, оба звучат естественно и профессионально."
              },
              {
                question: "Можно сначала послушать примеры?",
                answer: "Да, на этой странице есть примеры готовых песен. Послушайте - и сразу поймёте, что это не роботизированный звук, а полноценные треки, которые не стыдно включить на колонках."
              },
              {
                question: "Это точно будет уникально? Вдруг такая же песня уже у кого-то есть?",
                answer: "Исключено. Наша технология устроена так, что даже с похожими данными каждая песня создаётся с нуля: новая мелодия, аранжировка, структура. Это не шаблон, который просто подставляет имена. Каждый трек - оригинален на 100%."
              }
            ].map((faq, index) => (
              <motion.details
                key={index}
          ...
          >
            ...
            <div className="space-y-8 text-slate-700 dark:text-slate-300">
              ...
              <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-700">
                <p className="text-base md:text-lg font-semibold p-6 md:p-8 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border-2 border-purple-200 dark:border-purple-700 leading-relaxed">
