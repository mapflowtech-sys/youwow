        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8">
          ...
          >
            ...
            <div className="text-slate-700 dark:text-slate-300 leading-relaxed space-y-6">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4 text-slate-900 dark:text-white">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 dark:text-slate-300">
                <li><strong>Расскажите о человеке:</strong> опишите, кому предназначена песня, его интересы, характер, весёлые истории или важные моменты</li>
                <li><strong>Выберите стиль и жанр:</strong> поп, рок, рэп, шансон или любой другой жанр, который нравится получателю</li>
                <li><strong>Укажите голос:</strong> мужской или женский вокал — оба варианта звучат профессионально</li>
                <li><strong>Получите готовый трек:</strong> через 10 минут персональная песня придёт на вашу почту в формате MP3</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 dark:text-slate-300">
                <li><strong>День рождения</strong> — самый популярный повод. Песня про друга, сестру, брата или родителей станет главным событием праздника</li>
                <li><strong>Новый год</strong> — новогодняя персональная песня создаёт праздничное настроение и дарит тёплые эмоции</li>
                <li><strong>8 марта и 23 февраля</strong> — необычный способ поздравить коллег, друзей или родных</li>
                <li><strong>Годовщина отношений</strong> — романтичная песня для любимого человека с вашей общей историей</li>
                <li><strong>Свадьба</strong> — оригинальный подарок молодожёнам, который запомнится навсегда</li>
                <li><strong>Просто так</strong> — чтобы порадовать близкого человека без повода и показать, как он вам дорог</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 dark:text-slate-300">
                <li><strong>Скорость:</strong> готовая песня через 10 минут — идеально, если подарок нужен срочно</li>
                <li><strong>Профессиональное качество:</strong> студийный звук, живой вокал, качественная аранжировка</li>
                <li><strong>Доступная цена:</strong> всего 590 рублей за полноценную уникальную композицию</li>
                <li><strong>Персонализация:</strong> каждая песня создаётся индивидуально с учётом ваших пожеланий</li>
                <li><strong>Разнообразие жанров:</strong> от романтичного попа до энергичного рока и весёлого рэпа</li>
                <li><strong>Гарантия качества:</strong> если что-то не понравится, мы бесплатно доработаем песню</li>
              </ul>
              ...
              <p className="text-lg font-semibold mt-8 p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border-2 border-purple-200 dark:border-purple-700">
